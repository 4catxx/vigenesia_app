...
class AdminTambahMotivasi extends StatefulWidget {
  @override
  _AdminTambahMotivasiState createState() => _AdminTambahMotivasiState();
}

class _AdminTambahMotivasiState extends State<AdminTambahMotivasi> {
  ...
  void tambahMotivasi() async {
    ...
    var url = Uri.parse('http://localhost/vigenesia/api/dev/POSTmotivasi');
